...
import { ArrowLeft, Receipt, Check, Trash2, Bell } from "lucide-react"
import Link from "next/link"

const mock = [
  { id: "N-002", title: "Quotation Received", message: "TechSolutions Inc. has submitted a quotation for RFQ-2025-0004 — Server Hardware.", timestamp: "12 min ago", read: false },
  { id: "N-010", title: "Quotation Rejected", message: "Quotation from Global Supplies Co. for RFQ-2025-0012 has been rejected — High price.", timestamp: "1 day ago", read: true },
  { id: "N-013", title: "Quotation Revision Requested", message: "Acme Corp has been asked to revise their quotation for RFQ-2025-0007.", timestamp: "2 days ago", read: true },
]
          ...
          {notifications.map((n) => (
            <div key={n.id} className={`group relative rounded-xl border bg-white p-4 shadow-sm transition-all hover:shadow-md dark:bg-zinc-950 ${n.read ? "border-zinc-200 dark:border-zinc-800" : "border-indigo-200 bg-indigo-50/30 dark:border-indigo-800 dark:bg-indigo-950/20"}`}>
              <div className="flex items-start gap-3">
                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-purple-100 text-purple-600 dark:bg-purple-950/40 dark:text-purple-400">
