...
export default function AdminLogsGalaxyPage() {
      ...
      <div className="mx-auto max-w-5xl space-y-8 pb-16">
        <div className="flex flex-wrap items-center justify-between gap-4 border-b border-zinc-200 dark:border-zinc-800/80 pb-6">
          <div>
            ...
            <p className="mt-1 text-sm text-zinc-555 dark:text-cyan-400 font-semibold">
              Observe system infrastructure requests and role operations compiled as active stars.
            </p>
          </div>
        </div>
          ...
          {selectedStar && (
            ...
            >
              <div className="space-y-4">
                ...
                <p className="text-sm font-semibold text-zinc-850 dark:text-zinc-355">
                  {selectedStar.detail}
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 text-xs">
                <div className="flex items-center gap-2.5 rounded-xl bg-zinc-50 dark:bg-zinc-900/50 p-3 border border-zinc-200 dark:border-zinc-850">
                  ...
                  <div>
                    <p className="text-[9px] uppercase font-bold text-zinc-505">Operator</p>
                ...
                <div className="flex items-center gap-2.5 rounded-xl bg-zinc-50 dark:bg-zinc-900/50 p-3 border border-zinc-200 dark:border-zinc-850">
                  ...
                  <div>
                    <p className="text-[9px] uppercase font-bold text-zinc-505">Timestamp</p>
                ...
                <div className="flex items-center gap-2.5 rounded-xl bg-zinc-50 dark:bg-zinc-900/50 p-3 border border-zinc-200 dark:border-zinc-850 col-span-2">
                  ...
                  <div>
                    <p className="text-[9px] uppercase font-bold text-zinc-505">Audit IP Origin</p>
