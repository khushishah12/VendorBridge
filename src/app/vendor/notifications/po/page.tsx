...
import { CheckCheck, FileText, ExternalLink, Mail, MailOpen, BellOff, ClipboardList } from "lucide-react"
...
export default function PoNotificationsPage() {
  const [notifs, setNotifs] = useState(vendorNotifications.filter((n) => n.type === "po"))
      ...
      <div className="mx-auto max-w-4xl">
        <div className="mb-6 flex flex-wrap items-center justify-between gap-4">
          <div>
            <div className="flex items-center gap-2">
              <ClipboardList className="h-6 w-6 text-zinc-900 dark:text-zinc-50" />
              <h1 className="text-2xl font-bold text-zinc-900 dark:text-zinc-50">PO Notifications</h1>
        ...
        {notifs.length === 0 ? (
          <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-zinc-300 py-16 dark:border-zinc-700">
            ...
            <p className="text-lg font-medium text-zinc-500 dark:text-zinc-400">No PO notifications</p>
