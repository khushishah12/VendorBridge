...
import { vendorNotifications, type VendorNotification } from "@/lib/vendor-notification-data"
import { Bell, BellOff, FileText, ArrowUpRight, ExternalLink, CheckCheck, Mail, MailOpen } from "lucide-react"
...
export default function RfqNotificationsPage() {
  const [notifs, setNotifs] = useState(vendorNotifications.filter((n) => n.type === "rfq"))
      ...
      <div className="mx-auto max-w-4xl">
        <div className="mb-6 flex flex-wrap items-center justify-between gap-4">
          <div>
            <div className="flex items-center gap-2">
              <h1 className="text-2xl font-bold text-zinc-900 dark:text-zinc-50">RFQ Notifications</h1>
            ...
            <p className="mt-1 text-sm text-zinc-500 dark:text-zinc-400">
              Updates on requests for quotation
            </p>
          </div>
        ...
        {notifs.length === 0 ? (
          <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-zinc-300 py-16 dark:border-zinc-700">
            ...
            <p className="text-lg font-medium text-zinc-500 dark:text-zinc-400">No RFQ notifications</p>
