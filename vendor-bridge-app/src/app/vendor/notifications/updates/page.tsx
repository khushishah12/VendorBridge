...
import { CheckCheck, FileText, ExternalLink, Mail, MailOpen, BellOff, RefreshCw } from "lucide-react"
...
export default function UpdatesPage() {
  const [notifs, setNotifs] = useState(vendorNotifications.filter((n) => n.type === "update"))
      ...
      <div className="mx-auto max-w-4xl">
        <div className="mb-6 flex flex-wrap items-center justify-between gap-4">
          <div>
            <div className="flex items-center gap-2">
              <RefreshCw className="h-6 w-6 text-zinc-900 dark:text-zinc-50" />
              <h1 className="text-2xl font-bold text-zinc-900 dark:text-zinc-50">Updates & Changes</h1>
        ...
        {notifs.length === 0 ? (
          <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-zinc-300 py-16 dark:border-zinc-700">
            ...
            <p className="text-lg font-medium text-zinc-500 dark:text-zinc-400">No updates</p>
