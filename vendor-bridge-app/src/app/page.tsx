      ...
      <div className="mb-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
        {stats.map((stat) => (
          ...
          >
            ...
            <p className="mt-4 text-2xl font-bold text-zinc-900 dark:text-zinc-50">{stat.value}</p>
        ...
        <div className="space-y-0">
          {recentActivity.map((activity, i) => {
            ...
            return (
              <div
                key={i}
                className="flex items-start gap-4 border-b border-zinc-100 py-3 last:border-0 dark:border-zinc-800"
              >
